...
class Square:
    ...
    def rotate_normal_top(self, seq="x", angles=45):
        r = R.from_euler(seq, angles, degrees=True)
        self.n = r.apply(self.n)
        self.t = r.apply(self.t)
...
class ProbeGroup:
    ...
    def to_df(self):
        ...
        df["top"] = [tuple(e_pixel.t) for probe in self.probes for e_pixel in probe.e_pixels] + [
            tuple(d_pixel.t) for probe in self.probes for d_pixel in probe.d_pixels
        ]
